...
#' @keywords internal
htmlAdd <- function(text) {
  paste0("<ins>", paste0(text, collapse = ""), "</ins>")
}

#' @keywords internal
htmlDel <- function(text) {
  paste0("<del>", paste0(text, collapse = ""), "</del>")
}

#' @keywords internal
htmlSub <- function(from, to) {
  paste0("<del>", paste0(from, collapse = ""), "</del><ins>", paste0(to, collapse = ""), "</ins>")
}
